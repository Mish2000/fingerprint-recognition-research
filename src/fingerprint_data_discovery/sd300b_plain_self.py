"""Build and validate the SD300b plain_self protocol manifest."""
...
class ManifestGenerationError(ValueError):
    """Raised when the SD300b plain_self manifest cannot be generated safely."""
...
def build_plain_self_pairs(scan_result: ScanResult) -> list[PlainSelfPair]:
    """Build deterministic SD300b plain_self pairs from a completed SD300b scan."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate or validate the SD300b plain_self manifest."
    )
