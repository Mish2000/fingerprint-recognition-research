"""Build and validate the SD300b plain_roll genuine-pair manifest."""
...
class ManifestGenerationError(ValueError):
    """Raised when the SD300b plain_roll manifest cannot be generated safely."""
...
def build_plain_roll_pairs(scan_result: ScanResult) -> list[PlainRollPair]:
    """Build deterministic genuine SD300b plain-roll pairs from a completed SD300b scan."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate or validate the SD300b plain_roll manifest."
    )
